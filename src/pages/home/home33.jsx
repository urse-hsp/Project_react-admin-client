                ...
                <Card
                    ...
                    title={
                        <div className="home-menu">
                            <span className={isVisited ? 'home-menu-active home-menu-visited' : 'home-menu-visited'} onClick={this.handleChange(true)}>
                                访问量
                            </span>
                    ...
                    extra={<RangePicker defaultValue={[moment('2019/01/01', dateFormat), moment('2019/06/01', dateFormat)]} format={dateFormat} />}
                >
                    <Card className="home-table-left" title={isVisited ? '访问趋势' : '销售趋势'} bodyStyle={{ padding: 0, height: 275 }}>
                        <Bar />
                    </Card>
